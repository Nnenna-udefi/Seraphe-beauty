    ...
    <div className="min-h-screen">
      <div className=" mx-auto">
        <div className="bg-boxBg">
          <div className="flex max-w-7xl mx-auto flex-col gap-6  py-10 md:py-16 md:px-12 px-6">
            <H1>About Seraphé</H1>
        ...
        <div className="bg-primaryBg">
          <div className="max-w-7xl mx-auto  text-white py-12 px-6 md:px-12">
        ...
        {/* mission */}
        <div className="max-w-7xl mx-auto py-10 md:px-12 md:py-16 px-6 flex md:flex-row flex-col gap-6">
          <div>
            <div className="py-4">
              <H3>Our Mission</H3>
        ...
        <div className="max-w-7xl mx-auto pt-10 md:px-12 md:pt-16 flex flex-col px-6 justify content items-center text-center">
