        ...
        <div>
          <div className="text-black flex flex-col md:text-base text-sm">
            <p>
              ...
              saboteur hiding right in your vanity that could be undoing all of
              your hard work. When last did you clean your makeup brushes?
            </p>

            <p className="py-4">
              If you can’t remember, you aren&apos;t alone but you might want to
              read on to find out exactly why your dirty tools are holding you
              back from achieving flawless skin and perfect blending.
            </p>
            ...
            <p>
              ...
              Over time, your brushes become a breeding ground for elements you
              definitely don&apos;t want to be painting back onto your face:
            </p>
            <ol>
              <li>
              ...
              <li>
                Bacteria & Yeast: The dark, packed environment of brush bristles
                is the perfect home for microbes that cause infections and
                stubborn acne.
              </li>
              <li>
                {" "}
            ...
            <p>
              ...
              foundation application; it actively damages your skin health. The
            ...
            <p>
              ...
              don&apos;t need a complicated routine to keep your tools pristine,
              just follow this two-step guide:
            </p>

            <h4 className="font-medium pt-4">Step 1: Deep Clean</h4>
            <p>
              At least once a week, give your brushes a thorough wash. Use warm
              water along with a gentle brush cleanser or mild soap. Swirl the
              bristles gently on a silicone cleaning mat or directly in the palm
              of your hand. Rinse thoroughly, and repeat until the water runs
              completely clear.
            </p>
            ...
            <p>
              ...
              bristles with your fingers. Lay the brushes flat on a clean towel
              or hang them upside down to dry completely. NEVER dry them
              upright! When dried vertically, water seeps down into the ferrule
              (the metal part holding the glue), which loosens the adhesive and
              causes your brush bristles to shed.
            </p>
